...
A production-grade, end-to-end speech processing pipeline notebook ([pipeline.ipynb](pipeline.ipynb)) that converts raw outreach speech audio files into speaker-attributed transcripts, translations, and insights reports.
